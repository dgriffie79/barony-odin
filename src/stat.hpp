...
extern "C" void setDefaultMonsterStats(Stat* stats, int sprite);
extern "C" bool isMonsterStatsDefault(Stat& myStats);
extern "C" const char* getSkillLangEntry(int skill);
