...
#
void CustomHelpers::addMemberToSubkey(JsonNode d, std::string subkey, std::string name, JsonNode value) {
...
#
bool GameModeManager_t::isServerflagDisabledForCurrentMode(int i) {
