// main_types.odin — Odin mirrors of the structs/constants/enums in main.hpp.
//
// main.hpp is the misc/utility header: base data structures (node_t, list_t,
// map_t), math types (vec4_t, mat4x4_t), render types, enums, and #defines.
// Placement: main.hpp's types live here (main.odin holds the driver + the
// globals defined in main.cpp, per the mirror-the-definition-site rule).
package main
